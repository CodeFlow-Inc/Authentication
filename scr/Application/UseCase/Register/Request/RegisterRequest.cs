...
namespace Authentication.Aplication.UseCase.Register.Request;
...
public record RegisterRequest(
	...
	[property: Required(ErrorMessage = "Confirmação da senha é obrigatório")] string PasswordConfirm) : IRequest<RegisterResponse>;
