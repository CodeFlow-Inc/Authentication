...
namespace Authentication.Application.Application
{
    public class AuthApplication : IAuthApplication
    {
        ...
        public AuthApplication(IAuthRepository userRepository, IConfiguration configuration, SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager, IHttpContextAccessor httpContextAccessor)
        {
